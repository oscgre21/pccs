...
u.each(function(){var e=t(this);var n=e.attr("type");// Reveal mode feature is currently available for only radio and checkbox type answers
if(n==="radio"||n==="checkbox"){var i=o.indexOf(e.val())>-1;// $input.attr('data-is-correct') == '1';
var u=e.is(":checked");if(i){e.closest(".tutor-quiz-answer-single").addClass("tutor-quiz-answer-single-correct").append(s(__("Correct Answer","tutor"))).find(".tutor-quiz-answer-single-info:eq(1)").remove()}else{if(e.prop("checked")){e.closest(".tutor-quiz-answer-single").addClass("tutor-quiz-answer-single-incorrect")}}if(i&&!u){e.attr("disabled","disabled");a=false;r=true}}})}if(a){r=true}return r}/**
     *
...
var i=r(83650);// CONCATENATED MODULE: ./assets/react/helper/sprintf.js
/**
 ...
 * 
 * @returns string
 */function s(t){for(var e=arguments.length,r=new Array(e>1?e-1:0),o=1;o<e;o++){r[o-1]=arguments[o]}return t.replace(/%s/g,function(){return r.shift()})}/* ESM default export */const u=s;// EXTERNAL MODULE: ./assets/react/front/_select_dd_search.js
...
var C=r(1838);// EXTERNAL MODULE: ./assets/react/front/pages/instructor-list-filter.js
var z=r(39356);// CONCATENATED MODULE: ./assets/react/front/tutor-front.js
/**
 ...
 */readyState_complete(()=>{Object.entries(document.getElementsByTagName("a")).forEach(t=>{var e=t[1].getAttribute("href");if((e===null||e===void 0?void 0:e.includes("/logout"))||(e===null||e===void 0?void 0:e.includes("logout"))){t[1].setAttribute("data-no-instant","")}})});jQuery(document).ready(function(t){"use strict";/**
	 ...
	 * @since 1.9.0
	 */var{__,_x:r,_n:o,_nx:a}=wp.i18n;/**
	 * Initiate Select2
	 * @since v.1.3.4
...
t(".tutor-tabs-btn-group a").on("click touchstart",function(e){e.preventDefault();var r=t(this);var o=r.attr("href");t(".tutor-lesson-sidebar-tab-item").hide();t(o).show();t(".tutor-tabs-btn-group a").removeClass("active");r.addClass("active")});/**
	 ...
	 *
	 * @since v.1.4.4
	 */var s=t(".quiz-draggable-rand-answers").length;if(s){t(".quiz-draggable-rand-answers").each(function(){var e=t(this);var r=e.height();e.css({height:r})})}/**
	 * Datepicker initiate
	 *
	 * @since v.1.1.2
