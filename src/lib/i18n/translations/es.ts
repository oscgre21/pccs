...
export const es: Translations = {
  ...
  payment: {
    approved: {
      ...
      loadingDetails: 'Cargando detalles de la donación...',
      donationNotFound: 'Donación No Encontrada',
      donationNotFoundDesc: 'No se pudo encontrar la donación solicitada.',
      donationReceived: 'Donación Recibida',
      donationReceivedExclamation: '¡Donación Recibida!',
      thankYouMessage: 'Gracias por su generosa donación a Punta Cana Christian School',
      verifyingMessage: 'Su donación está siendo verificada',
      ...
      supportMakesDifference: 'Su Apoyo Hace la Diferencia',
      impactMessage: 'Su generosa donación nos ayuda a brindar educación cristiana de calidad a los niños en Punta Cana. Cada contribución impacta directamente el futuro de nuestros estudiantes y fortalece nuestra misión educativa.',
    },
    declined: {
  ...
  studentServices: {
    ...
    paymentForm: {
      ...
      termsCheckbox: 'He leído y acepto los',
      termsAndConditions: 'términos y condiciones',
      andThe: 'y la',
      privacyPolicy: 'política de privacidad',
      securityNote: 'Pago seguro con cifrado SSL. Procesado por AZUL, cumpliendo con los estándares PCI-DSS.',
      selectService: 'Seleccione un servicio',
      amountToPay: 'Monto a pagar (DOP)',
      suggested: 'sugerido',
      ...
      errors: {
        ...
        amountMinError: 'El monto debe ser mayor a 0',
      },
    },
  },
};
