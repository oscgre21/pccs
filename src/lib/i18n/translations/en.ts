...
export const en: Translations = {
  ...
  payment: {
    approved: {
      ...
      loadingDetails: 'Loading donation details...',
      donationNotFound: 'Donation Not Found',
      donationNotFoundDesc: 'The requested donation could not be found.',
      donationReceived: 'Donation Received',
      donationReceivedExclamation: 'Donation Received!',
      thankYouMessage: 'Thank you for your generous donation to Punta Cana Christian School',
      verifyingMessage: 'Your donation is being verified',
      ...
      supportMakesDifference: 'Your Support Makes a Difference',
      impactMessage: 'Your generous donation helps us provide quality Christian education to children in Punta Cana. Every contribution directly impacts the future of our students and strengthens our educational mission.',
    },
    declined: {
  ...
  studentServices: {
    ...
    paymentForm: {
      ...
      securityNote: 'Secure payment with SSL encryption. Processed by AZUL, compliant with PCI-DSS standards.',
      selectService: 'Select a service',
      amountToPay: 'Amount to pay (DOP)',
      suggested: 'suggested',
