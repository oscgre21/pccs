...
export function ValuesSection({ className = '' }: ValuesSectionProps) {
  ...
  const values = [
    {
      title: t.values.faith.title,
      description: t.values.faith.description,
      icon: (
    ...
    {
      title: t.values.gratitude.title,
      description: t.values.gratitude.description,
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 to-purple-900/70 flex items-center justify-center">
                <div className="text-center text-white">
                  <h3 className="text-2xl lg:text-4xl font-bold mb-4">{t.values.overlayTitle}</h3>
                  <p className="text-lg lg:text-xl">{t.values.overlaySubtitle}</p>
                </div>
              </div>
            </div>
          </div>
