...
export function PurposeSection({ className = '' }: PurposeSectionProps) {
  ...
  const purposeGoals = [
    {
      title: t.purpose.academicExcellence.title,
      description: t.purpose.academicExcellence.description,
      icon: (
    ...
    {
      title: t.purpose.missionOriented.title,
      description: t.purpose.missionOriented.description,
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
    ...
    {
      title: t.purpose.recognitionQuality.title,
      description: t.purpose.recognitionQuality.description,
      icon: (
            ...
            <div className="purpose-img-container">
              <div className="purpose-img relative">
                <img
                  ...
                  alt="PCCS Purpose - Center of academic excellence"
                  ...
                  <div className="bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        ...
                        <div className="text-xs text-gray-600">{t.purpose.statsCommitment}</div>
                      </div>
                      <div>
                        ...
                        <div className="text-xs text-gray-600">{t.purpose.statsExcellence}</div>
                      </div>
                      <div>
                        ...
                        <div className="text-xs text-gray-600">{t.purpose.statsQuality}</div>
                      </div>
                    </div>
                  </div>
                </div>
