            ...
            <div className="purpose-content">
              <div className="section-heading mb-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  At PCCS, our purpose goes beyond simple education. We are committed to creating
                  a center of excellence that recognizes and honors God in every aspect of our educational work.
                </p>
              </div>
          ...
          <div className="purpose-quote mt-16">
            <div className="rounded-2xl p-8 lg:p-12 text-center text-white" style={{ backgroundColor: '#1E1E8C' }}>
              ...
              <blockquote className="text-xl lg:text-2xl font-medium mb-6 leading-relaxed">
                "Our purpose is to form not only academically excellent students,
                but citizens of integrity who honor God in everything they do."
              </blockquote>
              <div className="text-indigo-200 font-semibold">
                PCCS Educational Philosophy
              </div>
            </div>
          </div>
        </div>
