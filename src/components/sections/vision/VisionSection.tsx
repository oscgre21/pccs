  ...
  const visionFeatures = [
    {
      ...
      title: t.vision.qualityEducation.title,
      description: t.vision.qualityEducation.description
    },
    {
      icon: (
      ...
      title: t.vision.welcomingEnvironment.title,
      description: t.vision.welcomingEnvironment.description
    },
    {
      icon: (
      ...
      title: t.vision.christianLeaders.title,
      description: t.vision.christianLeaders.description
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
      ...
      title: t.vision.trustIntegrity.title,
      description: t.vision.trustIntegrity.description
    }
  ];
