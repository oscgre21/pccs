            ...
            <div className="vision-img-container order-2 lg:order-1">
              <div className="vision-img relative">
                <img
                  ...
                  alt="PCCS Vision - Leadership in Christian education"
            ...
            <div className="vision-content order-1 lg:order-2">
              <div className="section-heading mb-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  To be recognized as leaders in providing quality bilingual Christian education,
                  affordable and accessible to all families. We aspire to create a dynamic
                  and welcoming educational environment, where every student feels valued and empowered to achieve their goals.
                </p>
                <p className="text-gray-600 leading-relaxed mb-8">
                  We seek to form Christian leaders who are citizens committed to social justice,
                  capable of facing the world's challenges with confidence, integrity and compassion.
                </p>
              </div>
